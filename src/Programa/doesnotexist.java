 ...
 */
public class doesnotexist extends javax.swing.JFrame {

    /**
     * Creates new form doesnotexist
     */
    public doesnotexist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("The key does not exist.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doesnotexist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doesnotexist().setVisible(true);
            }
        });
    }
